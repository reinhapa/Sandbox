...
/**
 * Utilities for common reflection based actions. Some are basic Java Reflection based, others are
 * CDI based.
 */
// X TODO: Look at merging this with some of the other classes from CODI, or if they're really
// needed
...
public abstract class ReflectionUtils {
  ...
  /**
   * Search the class hierarchy for a field with the given name. Will return the nearest match,
  ...
  /**
   * Get all the declared methods on the class hierarchy. This <b>will</b> return overridden
   * methods.
   *
   * @param clazz The class to search
  ...
  private static String buildInvokeMethodErrorMessage(Method method, Object obj, Object... args) {
    StringBuilder message = new StringBuilder(
        String.format("Details: Exception invoking method [%s] on object [%s], using arguments [",
            method.getName(), obj));
    if (args != null) {
   ...
   * <p/>
   * <p>
   * This method wraps {@link Method#invoke(Object, Object...)}, converting the checked exceptions
   * that {@link Method#invoke(Object, Object...)} specifies to runtime exceptions.
   * </p>
   * <p/>
   * <p>
   ...
   *         <code>instance</code> argument is not an instance of the class or interface declaring
   *         the underlying method (or of a subclass or implementor thereof); if the number of
  ...
  private static String createCustomMessage(Exception e, Method method, Object targetObject,
      Object... arguments) {
   ...
   * @return true if the class implements serializable or is a primitive (needed for type
   *         {@link Void}
   */
  ...
  public static Type[] getActualTypeArguments(Type type) {
    ...
    throw new IllegalArgumentException(
        (type != null ? type.getClass().getName() : "null") + " isn't supported");
  }
  ...
  public static int calculateHashCodeOfAnnotation(Annotation annotation,
    ...
    for (Method member : members) {
      ...
      // Member value
      final Object object =
          invokeMethod(annotation, member, Object.class, true, EMPTY_OBJECT_ARRAY);
      final int value;
  ...
  /**
   * We need this method as some weird JVMs return 0 as hashCode for classes. In that case we return
