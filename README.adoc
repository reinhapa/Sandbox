...
image:https://github.com/{project-full-path}/workflows/Java%20CI%20with%20Gradle/badge.svg["Java CI with Gradle", link="https://github.com/{project-full-path}/actions?query=workflow%3ACI"]
////
