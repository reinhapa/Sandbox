...
image:https://img.shields.io/badge/Java-15-blue.svg["Supported Versions", link="https://travis-ci.org/{project-full-path}"]
image:https://github.com/{project-full-path}/workflows/Java%20CI%20with%20Gradle/badge.svg["Java CI with Gradle", link="https://github.com/{project-full-path}/actions"]
////
